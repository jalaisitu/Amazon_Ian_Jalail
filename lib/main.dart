...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // NavBar con navegación a ProductPage
          NavBar(
            onSearch: () {
              Navigator.push(
                context,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                    ...
                    child: const Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text('Las cosas que amas están aquí.', style: TextStyle(color: Colors.white, fontSize: 16)),
                        ],
                      ),
                    ),
                  ),

                  // Grid de 8 ProductCards
                  GridView.count(
                    crossAxisCount: 4,
                    shrinkWrap: true,
                    ...
                    child: Column(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Row(
                            children: [
                              Text('Descubre productos italianos', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              SizedBox(width: 10),
                              Text('Descubre más', style: TextStyle(color: AppColors.linkBlue, fontSize: 13)),
                            ],
                          ),
                        ),
                        const Row(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Row(
                            children: [
                              Text('La tienda del Día de la Madre', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              SizedBox(width: 10),
                              Text('Compra ahora', style: TextStyle(color: AppColors.linkBlue, fontSize: 13)),
                            ],
                          ),
                        ),
                        const Row(
                  ...
                  // Grid inferior de 4 ProductCards
                  Container(
                    color: Colors.white,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Text('Ver recomendaciones personalizadas', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        ...
                        Container(
                          ...
                          child: const Text('Identificarse', style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        const SizedBox(height: 8),
                        const Text('¿Eres un cliente nuevo? Empieza aquí.', style: TextStyle(color: AppColors.linkBlue, fontSize: 13)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: const Center(
                      child: Text('Volver arriba', style: TextStyle(color: Colors.white, fontSize: 14)),
                    ),
                  ),
                  // Footer
                  Container(
                    ...
                    child: const Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        _FooterColumn(title: 'Descubre más', items: ['Ofertas del día', 'Novedades', 'Amazon Basics', 'Prime']),
                        _FooterColumn(title: 'Gana dinero con Amazon', items: ['Vende en Amazon', 'Afiliados', 'Amazon Business']),
                        _FooterColumn(title: 'Métodos de pago', items: ['Tarjeta de crédito', 'Recarga saldo', 'Amazon Cash']),
                        _FooterColumn(title: 'Ayuda', items: ['Tu cuenta', 'Tus pedidos', 'Devoluciones', 'Contactar']),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: const Center(
                      child: Text('amazon', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic)),
                    ),
                  ),
                ],
              ),
